...
- **Watch AI** mode — a heuristic bot (height / holes / bumpiness / line clears)
  plans placements and auto-plays. Pure logic lives in `src/game/ai.ts` with
  unit tests; the UI exposes **Watch AI** on the side panel and game-over dialog.
